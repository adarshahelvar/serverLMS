...
exports.activateUser = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (newUser.activationCode !== activation_code) {
            return next(new ErrorHandler_1.default(`Invaliad activation code`, 400));
        }
...
exports.updateAccessToken = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!session) {
            return next(new ErrorHandler_1.default("Please login for this resources", 400));
        }
        ...
        await redis_1.redis.set(user._id, JSON.stringify(user), "EX", 604800); // 604800 seconds means 7 days
        // res.status(200).json({
        //   status: "success",
        //   accessToken,
        // });
